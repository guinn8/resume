# Makefile for building resume and cover letters
...
COVER_LETTER_PDFS = $(patsubst $(COVER_LETTERS_DIR)/%.md, $(COVER_LETTERS_OUTPUT_DIR)/%.pdf, $(COVER_LETTER_MD))

# Build cover letters
$(COVER_LETTERS_OUTPUT_DIR)/%.pdf: $(COVER_LETTERS_DIR)/%.md $(COVER_LETTER_TEMPLATE) | $(COVER_LETTERS_OUTPUT_DIR)
